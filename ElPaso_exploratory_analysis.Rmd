...
# Projection CRS: ESRI 102341 (NAD_1983_HARN_StatePlane_Texas_South_FIPS_4205). 
# Spatial unit: meter.
CIP_layer <- st_read("Data/Resurfacing/CIP_PRogram_Master_Layer.shp") %>%
  st_transform('ESRI:102341')
...
pot_holes_sf <-
  ...
  st_as_sf(coords = c("WOXCOORDINATE", "WOYCOORDINATE"), 
           #crs ='ESRI:102341', need to be discussed to set the correct crs for the raw data
           agr = "constant")
