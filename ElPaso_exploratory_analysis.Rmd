...
```
```{r add plot and map themes for default visualizations}
...
ggplot() +
  geom_sf(data = El_Paso, color="grey") +
...
pot_holes_sf_last5yrs <- pot_holes_sf %>% dplyr::filter(YEAR > 2016)

# last five years map
ggplot() +
  geom_sf(data = El_Paso, fill="grey") +
  geom_sf(data = pot_holes_sf_last5yrs, aes(colour=YEAR), size=0.2, show.legend = "point") +
  labs(title = "Potholes 2016-2021",
       subtitle = "El Paso, TX") + mapTheme()

ggplot() +
  geom_sf(data = El_Paso, fill="grey") +
  geom_sf(data = pot_holes_sf, aes(colour=YEAR), size=0.2, show.legend = "point") +
  labs(title = "Potholes",
       subtitle = "El Paso, TX") + mapTheme()
