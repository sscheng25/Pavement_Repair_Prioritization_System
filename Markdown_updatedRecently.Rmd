...
To better inform our model, we wanted to understand the different parts of a road and what factors may lead to worsening conditions over time. We identified three main road anatomy-related features to pay attention to: the earth foundation, the roadbed base, and the surface.
...
EPCenterline_new7 <- EPCenterline_new7 %>% select(-CNTY_SEAT_FLAG)
...
```{r EPCenterline data splits, message=FALSE, warning=FALSE}
# 2016-2018
...
rf_enmodel2 <- randomForest(PCI_2018 ~  (road_age * CLASS) + dist_major_int + 
                              crash_len16_18 + dist_major_arterial,
                         data = EP_model_train, 
                         ntree=750,
                         mtry=3,
                         bootstrap=T)
