...
At this point we also import the hydrology features from the US Census.
...
EPhydrology <- st_intersection(El_Paso_city, hydrology)
```
...
To get the X and Y coordinates for waze jam data, we apply some string extraction on the raw `waze_data` dataset and build up a spatial data frame.
