...
tl_roads_PCI <- st_join(tl_roads, EPCenterline_new3, join=st_nearest_feature)
...
class_PCI<- EPCenterline_new3[c('index','CLASS','PCI_2018')]
...
paved_PCI<- EPCenterline_new3[c('index','STATUS','PCI_2018')]
