...
```{r add functional classification data}
...
Before we start building the predition models, we randomly split our existing dataset into training set (70%) and test set (30%).
