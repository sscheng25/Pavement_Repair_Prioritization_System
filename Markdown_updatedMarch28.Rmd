...
```{r echo=TRUE}
knitr::include_graphics("C:/Users/jenna/Documents/MCP/Spring_2022/MUSA801_Practicum/Pavement_Repair_Prioritization_System/Images/PCI-plot-white.jpg")
```
...
```{r echo=TRUE}
knitr::include_graphics("C:/Users/jenna/Documents/MCP/Spring_2022/MUSA801_Practicum/Pavement_Repair_Prioritization_System/Images/road_cross_section.png")
...
Looking at the variable distributions, we decided to explore some transformations.
...
```{r xgb predict and calculate errors, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
xgb_result <- x_test
...
## 6.7 Visualizing Select Model Results

### 6.7.1 Results for RF
