...
## FEMA Flood Zones - Preliminary 2020 Zones
...
```{r clip prelim flood zones to city, message=FALSE, warning=FALSE}
...
```{r join crash data to EPcenterline}
...
EPCenterline_new6$crash_count[is.na(EPCenterline_new6$crash_count)] <- 0
...
# convert to numeric
EPCenterline_new6$crash_len <- as.numeric(as.character(EPCenterline_new6$crash_len))
```

# Roadbed Data

```{r join roadbed feats to centerlines}
#rename target column and drop uneccessary columns
